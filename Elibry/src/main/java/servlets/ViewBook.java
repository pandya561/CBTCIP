...
public class ViewBook extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println(
				"<tr><th>Callno</th><th>Name</th><th>Author</th><th>Publisher</th><th>Quantity</th><th>Issued</th><th>Opertion</th></tr>");
		for (BookBean bean : list) {
			out.println("<tr><td>" + bean.getCallno() + "</td><td>" + bean.getName() + "</td><td>" + bean.getAuthor()
					...
					+ "'>Delete</a> | <a href='IssueBookForm?callno=" + bean.getCallno()
					+ "'>Issues</a></td>");
		}
