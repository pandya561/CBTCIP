...
public class ViewIssuedBook extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println(
				"<tr><th>Callno</th><th>Student Id</th><th>Student Name</th><th>Student Mobile</th><th>Issued Date</th><th>Return Status</th><th>Return</th></tr>");
		for (IssueBookBean bean : list) {
			out.println("<tr><td>" + bean.getCallno() + "</td><td>" + bean.getStudentid() + "</td><td>"
					...
					+ "</td><td>" + bean.getReturnstatus() + "</td><td><a href='ReturnBookForm?callno="+ bean.getCallno()+"&studentid="+bean.getStudentid()
					+"'>Retrun</a></td>");
		}
		out.println("</table>");
